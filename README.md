...
``` r
mar <- margin.HR2DRMST(m1=1, shape=1, tau=2.5, theta=0.833)
pow <- calculate_size(nL=200, nU=400, r=1, m1=1, m2=1.1, margin=mar$margin, p.s=0.3, tau=2.5, Ta=1.5, Te=3)
...
``` r
ab <- paramWeibull(m1=1, t1=2.5, surv.rate=0.1)
pow <- calculate_size(nL=20, nU=200, r=1, m1=1, m2=1.1, shape=ab[1], m0=0.5, f2=0.5, p.s=0.3, tau=2.5, Ta=1.5, Te=3)
