...
margin = $(1- f2) \times$ (RMST of the active control group - RMST of the hypothetical placebo group)
``` r
...
margin = (RMST of the active control group - RMST determined by a hazard ratio $\theta$), where 
